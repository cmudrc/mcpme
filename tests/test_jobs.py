...
from mcpcraft.execution import PythonCallableBinding, SubprocessBinding
...
def test_job_manager_get_avoids_false_lost_on_stale_running_reads(
    ...
    monkeypatch.setattr("mcpcraft._jobs._pid_exists", lambda pid: False)
