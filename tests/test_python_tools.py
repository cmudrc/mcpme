...
from mcpcraft._python_tools import (
...
from mcpcraft.schema import SchemaGenerationError
...
def test_static_python_resolver_helper_edges_are_explicit(tmp_path: Path) -> None:
    ...
    with pytest.raises(ImportError):
        resolver.discover_module("mcpcraft_missing_test_module")
