...
Source: ``examples/real_world/tigl_cpacs/use.py`` with companions ``examples/real_world/tigl_cpacs/ingest.py`` and ``examples/real_world/tigl_cpacs/serve.py``
...
.. literalinclude:: ../../../examples/real_world/tigl_cpacs/ingest.py
   :language: python
   :linenos:
   :lines: 11-
...
.. literalinclude:: ../../../examples/real_world/tigl_cpacs/serve.py
   :language: python
   :linenos:
   :lines: 3-
