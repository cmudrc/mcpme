...
The checked-in examples keep their preset support inputs in source control and
reserve ``artifacts/`` for derived outputs only. The richer real-world example
lane goes a step further and splits each walkthrough into ingest, serve, and
...
- :doc:`Examples <examples/index>` for both core and real-world runnable patterns
