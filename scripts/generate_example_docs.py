...
def _render_examples_index(
    ...
    lines = [
        ...
        "-------------",
        "",
        f"- ``examples/core/``: {len(core_specs)} maintained small examples.",
        (
            f"- ``examples/real_world/``: {len(real_world_specs)} richer optional "
            "workflows with persisted ingest artifacts."
        ),
        "",
