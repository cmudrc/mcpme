"""Ingest the pyCycle `MPCycle` wrapper into standard real-world example artifacts.
...
def main() -> None:
    ...
    # The checked-in shell wrapper is part of the real-world example contract, so make
    ...
    env = dict(os.environ)
    # The wrapper invokes `python -m mcpcraft.cli`, so give it this checkout's
