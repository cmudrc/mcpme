"""Ingest the TiGL helper package into standard real-world example artifacts.
...
def main() -> None:
    ...
    # Fail fast when the checked-in teaching assets drift so the real-world example
    ...
    for required_path in (
        ...
        if not required_path.exists():
            raise FileNotFoundError(
                f"Missing checked-in real-world example support file: {required_path}"
            )
