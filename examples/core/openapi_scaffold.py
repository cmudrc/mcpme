...
runtime AI layer. `mcpcraft` turns the spec into a plain Python HTTP facade, then
...
derived artifact under `artifacts/examples/core/openapi_scaffold/`.
...
- Build a manifest from the generated facade and execute the resulting tools
  through :func:`mcpcraft.execute_tool`.
...
generated facade remains available under `artifacts/examples/core/openapi_scaffold/`.
...
ARTIFACT_ROOT = REPO_ROOT / "artifacts" / "examples" / "core" / "openapi_scaffold"
