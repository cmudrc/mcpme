...
`artifacts/examples/core/subprocess_wrapper/`.

## Technical Implementation

- Keep the stand-in solver, `mcpcraft.toml`, and shell launcher checked in under
...
under `artifacts/examples/core/subprocess_wrapper/`.

## References

- ``README.md``
- ``examples/support/subprocess_wrapper/mcpcraft.toml``
...
from mcpcraft import ToolExecutionResult, build_manifest, execute_tool
...
def run_example() -> ToolExecutionResult:
    ...
    os.environ.setdefault("MCPCRAFT_EXAMPLE_SOURCE_ROOT", str(SOURCE_ROOT.resolve()))
