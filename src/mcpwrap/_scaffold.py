...
The generated facade files are intentionally plain Python modules. ``mcpwrap``
...
def _render_package_facade(
    ...
    *,
    ...
    parts = [
        f'"""Generated by ``mcpwrap scaffold-package`` for ``{package_name}``.',
        "",
        "This module is deterministic scaffolding. It is meant to be inspected,",
        "tested, and then wrapped through normal ``mcpwrap`` discovery.",
        '"""',
        "",
        "from __future__ import annotations",
        "",
...
def _render_command_facade(
    *,
    ...
    return "\n".join(
        [
            f'"""Generated by ``mcpwrap scaffold-command`` for ``{" ".join(command)}``.',
            "",
