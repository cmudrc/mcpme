    ...
    def handle_request(self, request: dict[str, Any]) -> dict[str, Any] | None:
        ...
        try:
                            ...
                            "experimental": {
                                "mcpcraftJobs": {
                                    "methods": [
                                        ...
                                        "mcpcraft/jobs/get",
                                        "mcpcraft/jobs/tail",
                                        "mcpcraft/jobs/cancel",
                                    ]
                                }
                            },
                        },
                        "serverInfo": {"name": "mcpcraft", "version": "0.1.0"},
                    },
                }
            ...
            if method == "tools/call":
                ...
                run_mode = meta.get("mcpcraft/runMode")
                if run_mode == "async":
            ...
            if method == "mcpcraft/jobs/cancel":
                if self.job_manager is None:
                    raise RuntimeError("Job manager is not initialized.")
                params = request.get("params", {})
                return {
