...
Python callables. That generated file can then be discovered by ``mcpcraft`` like
...
def _render_openapi_facade(
    *,
    ...
    parts = [
        f'"""Generated by ``mcpcraft scaffold-openapi`` for ``{spec_path}``.',
        "",
