...
The generated facade files are intentionally plain Python modules. ``mcpme``
...
def _render_package_facade(
    ...
    *,
    ...
    parts = [
        f'"""Generated by ``mcpme scaffold-package`` for ``{package_name}``.',
        "",
        "This module is deterministic scaffolding. It is meant to be inspected,",
        "tested, and then wrapped through normal ``mcpme`` discovery.",
        '"""',
        "",
        "from __future__ import annotations",
        "",
...
def _render_command_facade(
    *,
    ...
    return "\n".join(
        [
            f'"""Generated by ``mcpme scaffold-command`` for ``{" ".join(command)}``.',
            "",
